...
wave.color = 0x555555;
const wave2 = new SineWave(30, 700, 1.5, Math.PI * Math.random(), 400);
wave2.fill = FillMode.UP;
wave2.color = 0x888888;
const wave3 = new SineWave(25, 800, 2, Math.PI * Math.random(), 600);
wave3.fill = FillMode.UP;
wave3.color = 0xaaaaaa;
const wave4 = new SineWave(20, 1000, 3, Math.PI * Math.random(), 900);
wave4.fill = FillMode.UP;
wave4.color = 0xcccccc;

var canvas = new Canvas(1920, 1080, "image");
